...
\rev{The introduction argued that the graph has to earn its place. Deciding that for a given system requires stating what counts as a system, what counts as evidence about one, and which questions this review declines to answer. This section fixes those boundaries before the analysis begins.}
