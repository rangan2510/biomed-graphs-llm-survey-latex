...
% and the IEEE Fellow class lists. The four junior entries are deliberately
% thin: no degree year, title, or honours could be verified from a citable
% source, so those entries state only affiliation and research area and need
% each author to complete them.
...
is with the Department of Computer Science and Engineering, Jadavpur University, Kolkata, India. His research interests include deep learning, graph neural networks, and their application to biomedical data.
\end{IEEEbiography}
